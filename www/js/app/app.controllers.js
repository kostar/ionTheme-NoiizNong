angular.module('your_app_name.app.controllers', [])
  ...
  .controller('ProfileCtrl', function ($scope, $stateParams, PostService, $ionicHistory, $state, $ionicScrollDelegate, AuthService) {
  ...
  .controller('SettingsCtrl', function ($scope, $ionicModal, AuthService, $state) {
